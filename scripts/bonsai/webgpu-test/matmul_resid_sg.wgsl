// Subgroup split-K GEMV for decode (M=1) with fused residual: y[n] = x @ W[n]^T + resid[n].
// One subgroup per output column, lanes split K, subgroupAdd reduction. Used for o_proj / down_proj.
enable subgroups;
override SG: u32 = 32u;
